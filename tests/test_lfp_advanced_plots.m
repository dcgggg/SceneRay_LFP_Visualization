...
verifyEqual(testCase, numel(h1.axes), 6);
verifyTrue(testCase, contains(string(get(get(h1.axes(1), 'Title'), 'String')), 'Raw'));
verifyTrue(testCase, contains(string(get(get(h1.axes(2), 'Title'), 'String')), 'Clean'));
