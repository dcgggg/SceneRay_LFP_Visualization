...
verifyTrue(testCase, isinf(cfg.plot.maxPlotSeconds));
verifyEqual(testCase, cfg.psd.maxArtifactFraction, 0);
verifyEqual(testCase, cfg.psd.frequencyRange, [1 35]);
verifyEqual(testCase, string(cfg.psd.method), "multitaper");
