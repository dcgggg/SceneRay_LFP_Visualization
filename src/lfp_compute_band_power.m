...
data.bandPower = struct('table', resultTable, 'bands', bands, ...
    ...
    'effectiveReferenceRangeHz', referenceInterval, ...
    'frequencyRangeHz', [frequencyHz(1), frequencyHz(end)], ...
...
entry = struct('operation', "band_power", ...
    ...
    'effectiveReferenceRangeHz', referenceInterval, 'frequencyRangeHz', [frequencyHz(1), frequencyHz(end)]), ...
